...
export default function MobileNav() {
  ...
  const tabs = [
    { href: '/writeups', label: 'Stories', icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path>
        <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path>
      </svg>
    )},
    { href: '/infographics', label: 'Infographics', icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-[var(--dark)] border-t border-white/10 md:hidden z-50">
        <div className="flex justify-around items-center py-2">
          ...
          <button
            onClick={toggleTheme}
            className="flex flex-col items-center gap-1 px-3 py-2 text-white/60"
          >
            {theme === 'light' ? (
          ...
          {!hasSubscribed && (
            <button
              ...
              className="flex flex-col items-center gap-1 px-3 py-2 text-[var(--accent)]"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
